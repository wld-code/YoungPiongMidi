...
mapping), per the project spec's section 17: "DSP algorithms should be
...
`yp_level_to_velocity`) and `note_state_machine.c` have zero ESP-IDF
dependency by design - they only ever include
